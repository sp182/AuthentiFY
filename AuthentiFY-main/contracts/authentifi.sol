...
*/
    ...
    function createCode(
        ...
        uint _status,
        string _description,
        string _manufactuerName,
        string _manufactuerLocation,
        string _manufactuerTimestamp
    ...
    function getNotOwnedCodeDetails(string _code)
        public
        view
        returns (
            string,
    ...
    function getOwnedCodeDetails(string _code)
        public
        view
    ...
    function addRetailerToCode(string _code, string _hashedEmailRetailer)
        public
        payable
        returns (uint)
    {
    ...
    function getRetailerDetails(string _code)
        public
        view
        returns (string, string)
    {
    ...
    function reportStolen(string _code, string _customer)
        public
        payable
        returns (bool)
    {
    ...
    function remove(uint index, string[] storage array)
        internal
        returns (bool)
    {
